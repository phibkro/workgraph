...
export const tracerFixture: WorkGraph = {
  ...
  nodes: [
    ...
    },
    {
      ...
      evidenceRole: "operational_observation",
    },
    {
  ...
  edges: [
    ...
    {
      id: "edge:cap-lag-optional-replay",
      kind: "requires",
      from: "cap:lag-attribution",
      to: "exp:replay-harness",
  ...
  events: [
    ...
    },
    {
      ...
      policy: "workgraph.policy.administrative-assumption",
      policyVersion: "1",
    ...
    },
    {
      ...
      policy: "orchard.policy.probe-acceptance",
      policyVersion: "1",
    ...
    },
    {
      ...
      policy: "orchard.policy.gate-0001",
      policyVersion: "1",
      ...
      basis: [
        {
          ...
          observedVersion: "incident-revision-0001",
